...
parser.add_argument("-env", type=str,default="LunarLanderContinuous-v2", help="Environment name, default = Pendulum-v0")
...
parser.add_argument("-frames", type=int, default=1000000, help="The amount of training interactions with the environment, default is 100000")
parser.add_argument("-eval_every", type=int, default=50000, help="Number of interactions after which the evaluation runs are performed, default = 5000")
...
parser.add_argument("-layer_size", type=int, default=512, help="Number of nodes per neural network layer, default is 256")
...
parser.add_argument("-t", "--tau", type=float, default=1e-3, help="Softupdate factor tau, default is 1e-2")
